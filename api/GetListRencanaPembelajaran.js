...
const authToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..hmESaZJp8PfWw9oOF10eBUJyVSbQ-vKE1Zd5mByAFZk';
...
function createTableQuery(data) {
    ...
    let createQuery = `CREATE TABLE IF NOT EXISTS akademik.map_rencanaajar (\n`;
...
function insertDataQuery(data) {
    let insertQuery = 'INSERT INTO akademik.map_rencanaajar VALUES \n';
    ...
    try {
      ...
      while (true) {
        ...
        if (offset === 0) {
          ...
          await db.none('DROP TABLE IF EXISTS akademik.map_rencanaajar');
        }
