...
const authToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..KD84pet7h0QCys_D0dT6da9b5s837zWS3JF37gzimjs';
...
function createTableQuery(data) {
    ...
    let createQuery = `CREATE TABLE IF NOT EXISTS integrator.map_biodatamahasiswa (\n`;
  ...
  function insertDataQuery(data) {
    let insertQuery = 'INSERT INTO integrator.map_biodatamahasiswa VALUES \n';
    ...
    try {
      ...
      while (true) {
        ...
        if (offset === 0) {
          ...
          await db.none('DROP TABLE IF EXISTS integrator.map_biodatamahasiswa');
        }
