...
const authToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..RyV5ZUUsbihM9I0iTbJEClcXs_YIFwCiz_cXU9Lx_0U';
const baseUrl = 'http://172.26.80.39:3003/ws/live2.php?wsdl';
...
function createTableQuery(data) {
    ...
    let createQuery = `CREATE TABLE IF NOT EXISTS integrator.map_mahasiswalengkap (\n`;
    ...
    try {
      ...
      while (true) {
        const response = await axios.post(baseUrl, {
          ...
          token,
          filter:"id_prodi = '069b02a6-ab86-4d36-aba5-2ce2aa3e7dbd' and id_periode='20131'",
          offset,
          limit: chunkSize,
        }, {
          maxContentLength,
        ...
        if (offset === 0) {
          ...
          await db.none('DROP TABLE IF EXISTS integrator.map_mahasiswalengkap');
        }
