...
const authToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..TXzFDVP4zMEfjUNtpqSMUguJYuRh1LYCZlmLw33N9g8';
...
function createTableQuery(data) {
    ...
    let createQuery = `CREATE TABLE IF NOT EXISTS akademik.map_jalurmasuk (\n`;
  ...
  function insertDataQuery(data) {
    let insertQuery = 'INSERT INTO akademik.map_jalurmasuk VALUES \n';
    ...
    try {
      ...
      while (true) {
        ...
        if (offset === 0) {
          ...
          await db.none('DROP TABLE IF EXISTS integrator.map_jalurmasuk');
        }
