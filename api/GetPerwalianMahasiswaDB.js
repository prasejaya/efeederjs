...
const authToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..NktSR51G9ZWZnRIybcTWY_m09sQuR5zqGKh8awhemq4';
...
function createTableQuery(data) {
    ...
    let createQuery = `CREATE TABLE IF NOT EXISTS integrator.map_perwalian (\n`;
...
function insertDataQuery(data) {
    let insertQuery = 'INSERT INTO integrator.map_perwalian VALUES \n';
    ...
    try {
      ...
      while (true) {
        ...
        if (offset === 0) {
          ...
          await db.none('DROP TABLE IF EXISTS integrator.map_perwalian');
        }
