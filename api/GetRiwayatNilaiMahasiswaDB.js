...
const authToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..rHbmznxzxHj4MWTbZANnqKP44BOkADiAz5wm2BXZBpU';
...
function createTableQuery(data) {
    ...
    let createQuery = `CREATE TABLE IF NOT EXISTS akademik.map_periodeperkuliahan (\n`;
...
function insertDataQuery(data) {
    let insertQuery = 'INSERT INTO akademik.map_periodeperkuliahan VALUES \n';
    ...
    try {
      ...
      while (true) {
        ...
        if (offset === 0) {
          ...
          await db.none('DROP TABLE IF EXISTS akademik.map_periodeperkuliahan');
        }
