...
const authToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..UJHJV27-f256uewSWBu1dFrBTmjwWYZD66dlG68AgNU';
...
function createTableQuery(data) {
    ...
    let createQuery = `CREATE TABLE IF NOT EXISTS integrator.map_biodata2 (\n`;
  ...
  function insertDataQuery(data) {
    let insertQuery = 'INSERT INTO integrator.map_biodata2 VALUES \n';
  ...
  try {
    ...
    while (true) {
      ...
      if (chunkData.length === 0) {
        ...
        const insertedData = await db.any('SELECT * FROM integrator.map_biodata2');
      ...
      if (offset === 0) {
        ...
        await db.none('DROP TABLE IF EXISTS integrator.map_biodata2');
      }
