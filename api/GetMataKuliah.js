...
function createTableQuery(data) {
    ...
    let createQuery = `CREATE TABLE IF NOT EXISTS integrator.map_kurikulumprodi (\n`;
  ...
  function insertDataQuery(data) {
    let insertQuery = 'INSERT INTO integrator.map_kurikulumprodi VALUES \n';
    ...
    try {
      ...
      while (true) {
        ...
        if (offset === 0) {
          ...
          await db.none('DROP TABLE IF EXISTS integrator.map_kurikulumprodi');
        }
