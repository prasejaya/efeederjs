...
const authToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..IfUMEi_v8-7extmZ8HYDyOCdLlrgSwBGrmM6oFhR5kA';
...
function createTableQuery(data) {
    ...
    let createQuery = `CREATE TABLE IF NOT EXISTS integrator.map_detailkurikulum (\n`;
  ...
  function insertDataQuery(data) {
    let insertQuery = 'INSERT INTO integrator.map_detailkurikulum VALUES \n';
  ...
  try {
    ...
    while (true) {
      ...
      if (chunkData.length === 0) {
        ...
        // Tampilkan data yang berhasil diinput
        const insertedData = await db.any('SELECT * FROM integrator.map_detailkurikulum');
        console.log('Data yang berhasil diinput:', insertedData);
      ...
      if (offset === 0) {
        ...
        await db.none('DROP TABLE IF EXISTS integrator.map_detailkurikulum');
      }
