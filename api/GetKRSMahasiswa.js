...
const authToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.._YB6q1ebWiOQhAZu_4_Sca9BmoJhvSYFx_qgqR_jApk';
...
function createTableQuery(data) {
    ...
    let createQuery = `CREATE TABLE IF NOT EXISTS integrator.map_krs (\n`;
  ...
  function insertDataQuery(data) {
    let insertQuery = 'INSERT INTO integrator.map_krs VALUES \n';
    ...
    try {
      ...
      while (true) {
        ...
        if (offset === 0) {
          ...
          await db.none('DROP TABLE IF EXISTS integrator.map_krs');
        }
